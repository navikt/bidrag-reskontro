...
@ContextConfiguration(classes = [BidragReskontroLocal::class])
@SpringBootTest(classes = [BidragReskontroLocal::class, StubUtils::class], webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
